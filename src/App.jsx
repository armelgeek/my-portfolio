    ...
    <div className='h-screen w-full'>
      <div className="grid grid-cols-5 grid-rows-5 w-full h-full  bg-white">
        ...
        <div className="row-span-4 row-start-2 w-12 h-full">
          <div className='flex flex-col fixed top-0 bottom-0 justify-end gap-5  w-32  h-full items-center'>
        ...
        <div className="row-span-3 col-start-5 md:ml-36 row-start-2">
          <div className='flex flex-col fixed right-0 top-20 bottom-0 justify-start gap-5  h-full items-center'>
            <div className='w-0.5 h-36 bg-black'></div>
        ...
        <div className="col-span-3 row-span-3 col-start-2 row-start-2 w-full h-full max-h-full">
          ...
          <div className="flex flex-row  gap-3 mt-10 h-96">
            <div className="flex flex-row gap-3">
              ...
              <div className="w-[650px] bg-gray-100">
                <TiakaloMob />
              </div>
            </div>
          </div>
                ...
                <div className="flex flex-col gap-4 h-full justify-center items-start">
                  ...
                  <div className="flex flex-row items-center gap-5 mt-2">
                    <a href="http://" style={{
                      fontFamily: "Karla",
                      fontWeight: "bold",
                    }} className='py-2 bg-purple-500  rounded-full text-white text-md px-5 bg-white-500 border-2 border-slate-300'>Voir le démos </a>
            ...
            <div className="flex flex-row gap-3">
              <div className="w-[350px] p-3 shadow-sm border">
                ...
                <small style={{
                  ...
                  <div className="flex flex-row items-center gap-5 mt-2">
                    <a href="https://github.com/armelgeek/cms-challenge" style={{
                      fontFamily: "Karla",
                      fontWeight: "bold",
          ...
          <h3 id="mes-experiences" className="heading--underlined text-purple-500 text-3xl mt-20 font-semibold" style={{
            fontFamily: "Pacifico,sans-serif"
          }}>
          ...
          <div class="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
            <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              <div class="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-slate-300 group-[.is-active]:bg-purple-500 text-slate-500 group-[.is-active]:text-purple-50 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
              ...
              <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                <div class="flex items-center justify-end space-x-2 mb-1">
                  <time class="font-medium text-purple-500" style={{
                    fontFamily: 'Karla'
                  }}>30 Octobre 2022 – Maintenant </time>
                </div>

                <div class="font-bold text-slate-900 text-lg mb-3" style={{
                  fontFamily: 'Karla'
                }}>Développeur PHP chez Open Atlas (Full Remote)</div>
                <div class="text-slate-500" style={{
                  fontFamily: 'Karla'
                }}>
            ...
            <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                ...
                <div class="font-bold text-slate-900 text-lg  mb-3">Developpeur FullStack chez Blue Cactus Factory</div>
            ...
            <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                ...
                <div class="font-bold text-slate-900  text-lg">Concepteur et Développeur pour Officine Veterinaire Ambalavao</div>
                <div class="text-slate-500" style={{
                  fontFamily: 'Karla'
                }}>
                  <div className='flex flex-col gap-2'>
            ...
            <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                ...
                <div class="font-bold text-slate-900 text-lg" style={{
                  fontFamily: 'Karla'
            ...
            <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              <div class="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-purple-500 group-[.is-active]:bg-purple-500 text-white group-[.is-active]:text-purple-50 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
                <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" width="12" height="10">
                  <path fill-rule="nonzero" d="M10.422 1.257 4.655 7.025 2.553 4.923A.916.916 0 0 0 1.257 6.22l2.75 2.75a.916.916 0 0 0 1.296 0l6.415-6.416a.916.916 0 0 0-1.296-1.296Z" />
                </svg>
              </div>
          ...
          <footer class="bg-white m-4">
            <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
              ...
              <span class="block text-md text-gray-900 sm:text-center" style={{
                fontFamily: 'Karla'
              }}>© 2023 <a href="https://www.linkedin.com/in/armelwanes/" class="hover:underline">Armel Wanes</a>. All Rights Reserved.</span>
            </div>
          </footer>
