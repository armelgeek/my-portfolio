      ...
      <div className="grid grid-cols-5 grid-rows-5 w-full h-full  bg-white">
        ...
        <div className="col-span-3 row-span-3 col-start-2 row-start-2 w-full h-full max-h-full">
                ...
                <div className="flex mt-5 flex-row gap-5">
                  ...
                  <a style={{
                    ...
                    fontWeight: "bold",
                     ...
                     className='py-2 text-md px-5 rounded-full flex flex-row gap-2 items-center bg-white-500 border-2 border-purple-500'>Télécharger
                    mon CV <FaCircleArrowRight className='text-purple-500'/></a>
                </div>
              </div>
              <div
                  className='flex flex-row flex-wrap justify-center items-center mb-6 lg:mb-0 lg:justify-start mt-10 gap-5'>
              ...
              <div className="w-full lg:w-[350px] p-3 shadow-sm border">
                <div className="flex flex-col gap-4 h-full justify-center items-start">
                  ...
                  <ul style={{
                    ...
                    <li style={{
                      fontFamily: 'Karla,sans-serif'
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/> React Native
                    </li>
                    <li style={{
                      fontFamily: 'Karla,sans-serif'
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/>Node JS
                    </li>
                    <li style={{
                      fontFamily: 'Karla,sans-serif',
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/> Neo4j
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="flex flex-row gap-3">
              <div className="w-full lg:w-[350px] p-3 shadow-sm border">
                <div className="flex flex-col gap-4 h-full justify-center items-start">
                  ...
                  <ul style={{
                    ...
                    <li style={{
                      fontFamily: 'Karla,sans-serif'
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/> Next JS
                    </li>
                    <li style={{
                      fontFamily: 'Karla,sans-serif'
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/>Shadcn UI
                    </li>
                    <li style={{
                      fontFamily: 'Karla,sans-serif',
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/>Prisma ORM
                    </li>

                    <li style={{
                      fontFamily: 'Karla,sans-serif',
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/>Stripe JS
                    </li>


                    <li style={{
                      fontFamily: 'Karla,sans-serif',
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/>Zustand
                    </li>

                    <li style={{
                      fontFamily: 'Karla,sans-serif',
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/> TailWind CSS
                    </li>
                  </ul>
                  <div className="flex flex-row items-center gap-5 mt-2">
                    <a target='_blank' href="https://github.com/armelgeek/learning-academy" style={{
                      ...
                      fontWeight: "bold",
                       ...
                       className='py-2 bg-white flex flex-row gap-2 rounded-full text-black text-md px-5 bg-white-500 border border-slate-300'>
              ...
              <div className="hidden  lg:block md:w-[650px] lg:[650px] bg-gray-100">
                <div className='w-full h-full flex justify-center items-center'>
                  <p className="text-gray-400 text-2xl">Pas encore d'apercu</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="w-full lg:w-[350px] p-3 shadow-sm border">
                <div className="flex flex-col gap-4 h-full justify-center items-start">
                  ...
                  <ul style={{
                    ...
                    <li style={{
                      fontFamily: 'Karla,sans-serif',
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/>Redux
                    </li>
                    <li style={{
                      fontFamily: 'Karla,sans-serif',
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/>React Native Reanimated 2
                    </li>
                  </ul>
                  <div className="flex flex-row items-center gap-5 mt-2">
                    <a
                        ...
                        className='py-2 flex flex-row gap-2 items-center bg-purple-500  rounded-full text-white text-md px-5 bg-white-500 border-2 border-slate-300'><FaEye/>Video
                      démo </a>
              ...
              <div className="w-full lg:w-[350px] p-3 shadow-sm border">
                <div className="flex flex-col gap-4 h-full justify-center items-start">
                  ...
                  <ul style={{
                    ...
                    <li style={{
                      fontFamily: 'Karla,sans-serif'
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/> React JS
                    </li>
                    <li style={{
                      fontFamily: 'Karla,sans-serif'
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/>Express JS
                    </li>
                    <li style={{
                      fontFamily: 'Karla,sans-serif',
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/>MySQL
                    </li>
                    ...
                    <li style={{
                      fontFamily: 'Karla,sans-serif',
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/>Web Scrapping
                    </li>
                  ...
                  <div className="flex flex-row justify-center mb-5 lg:justify-start items-center gap-5 mt-2">
                    <a target='_blank' href="https://youtu.be/ZcnEaSl3KFo" style={{
                      ...
                      fontWeight: "bold",
                       ...
                       className='py-2 bg-purple-500  rounded-full text-white text-md px-5 bg-white-500 border-2 border-slate-300'>Video
                      démo </a>
              ...
              <div className="w-full lg:w-[350px] p-3 shadow-sm border">
                <div className="flex flex-col gap-4 h-full justify-center items-start">
                  ...
                  <ul style={{
                    ...
                    <li style={{
                      fontFamily: 'Karla,sans-serif',
                    }} className='flex flex-row gap-2 items-center'><FaChevronRight/> Bootstrap 4
                    </li>
                  </ul>
                  <div className="flex flex-row items-center gap-5 mt-2">
          ...
          <h3 id="mes-experiences"
              className="heading--underlined text-purple-500 text-center lg:text-left text-3xl mt-20 font-semibold"
              style={{
                fontFamily: "Pacifico,sans-serif"
              }}>
          ...
          <div
            ...
            <div
              ...
              <div
                ...
                <div className="font-bold text-slate-900 text-lg  mb-3">Developpeur FullStack JS chez Relia Consulting
            ...
            <div
              ...
              <div
                ...
                <div className="font-bold text-slate-900 text-lg  mb-3">Developpeur FullStack JS chez Blue Cactus
                  Factory
                </div>
            ...
            <div
              ...
              <div
                ...
                <div className="font-bold text-slate-900  text-lg">Concepteur et Développeur pour Officine Veterinaire
                  Ambalavao
                </div>
                <div className="text-slate-500" style={{
                  fontFamily: 'Karla'
